...
<body>
  ...
  <div id="container_imovel">
    ...
    <div id="sub_container2">
        ...
        <h2 class="text-center"><?php echo $imovel->getTipoImovel();?> | <?php echo $imovel->getRua();?> | <?php echo $imovel->getPreco(); ?> € <?php if (isset($_SESSION['cliente'])) { ?><a href="#"></a><i title="Marcar visita ao imóvel" class="fas fa-eye fa-1x" id="atalho_marcar_visita"></i></h2><?php } ?>
    ...
    <div id="sub_container">
      ...
      <!-- Descrição do imóvel -->
      <p class="descricao_imovel"><?php echo $imovel->getDescricao(); ?></p>
